...
class DynamicConditionBuilder {
    constructor(sqlBuilder, definition) {
    ...
    processFilter(filter, definition, prefix) {
    ...
    processColumnFilter(filter, valueSource, column) {
        let result = new ValueSourceImpl_1.SqlOperationValueSourceIfValueAlwaysNoop();
    ...
    processAndFilter(filter, definition, prefix) {
        let result = new ValueSourceImpl_1.SqlOperationValueSourceIfValueAlwaysNoop();
    ...
    processOrFilter(filter, definition, prefix) {
        let result = new ValueSourceImpl_1.SqlOperationValueSourceIfValueAlwaysNoop();
        for (let i = 0, length = filter.length; i < length; i++) {
            const condition = this.processFilter(filter[i], definition, prefix);
