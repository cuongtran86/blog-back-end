...
export declare type UpdateSets<TABLE extends ITableOrView<any>, USING extends ITableOrView<any>, SHAPE> = SHAPE extends undefined ? ({
...
export declare type UpdateValues<TABLE extends ITableOrView<any>, SHAPE> = SHAPE extends undefined ? ({
...
export declare type UpdateShape<TABLE extends ITableOrView<any>, USING extends ITableOrView<any>> = TABLE[typeof database] extends (NoopDB | MariaDB | MySql) ? {
...
declare type FilterTables<USING extends ITableOrView<any>> = USING extends ITable<any> ? USING : never;
export declare type OptionalUpdateSets<TABLE extends ITableOrView<any>, USING extends ITableOrView<any>, SHAPE> = SHAPE extends undefined ? ({
...
declare type InputTypeOfColumnAllowingForShape<SHAPE, K extends ColumnsOfShape<SHAPE>, ALLOWING extends ITableOrView<any>> = SHAPE[K] extends ValueSourceOf<any> ? (SHAPE[K] extends ColumnWithDefaultValue ? (ValueSourceValueType<SHAPE[K]> | RemapIValueSourceType<ALLOWING[typeof tableOrViewRef] | NoTableOrViewRequired<SHAPE[K][typeof database]>, SHAPE[K]> | Default) : (ValueSourceValueType<SHAPE[K]> | RemapIValueSourceType<ALLOWING[typeof tableOrViewRef] | NoTableOrViewRequired<SHAPE[K][typeof database]>, SHAPE[K]>)) : never;
declare type InputTypeOfOptionalColumnAllowingForShape<SHAPE, K extends ColumnsOfShape<SHAPE>, ALLOWING extends ITableOrView<any>> = SHAPE[K] extends ValueSourceOf<any> ? (SHAPE[K] extends ColumnWithDefaultValue ? (ValueSourceValueType<SHAPE[K]> | RemapIValueSourceTypeWithOptionalType<ALLOWING[typeof tableOrViewRef] | NoTableOrViewRequired<SHAPE[K][typeof database]>, SHAPE[K], any> | Default) : (ValueSourceValueType<SHAPE[K]> | RemapIValueSourceTypeWithOptionalType<ALLOWING[typeof tableOrViewRef] | NoTableOrViewRequired<SHAPE[K][typeof database]>, SHAPE[K], any>)) : never;
