...
export declare type SafeArgForFn<TABLE_OR_VIEW extends ITableOrViewRef<AnyDB>, ARG> = ARG extends Argument<any, infer OPTIONAL_TYPE, infer MODE, any> ? (MODE extends 'value' ? never : ('required' extends OPTIONAL_TYPE ? MapArgumentToITypeSafe<TABLE_OR_VIEW, ARG> : MapArgumentToITypeSafeAsAnyOptionalType<TABLE_OR_VIEW, ARG>)) : never;
export declare type UnsafeArgForFn<TABLE_OR_VIEW extends ITableOrViewRef<AnyDB>, ARG> = ARG extends Argument<any, infer OPTIONAL_TYPE, infer MODE, any> ? (MODE extends 'value' ? never : ('required' extends OPTIONAL_TYPE ? MapArgumentToITypeUnsafe<TABLE_OR_VIEW, ARG> : MapArgumentToITypeUnsafeAsAnyOptionalType<TABLE_OR_VIEW, ARG>)) : never;
...
export declare type SafeArgForBuilderIfValue<TABLE_OR_VIEW extends ITableOrViewRef<AnyDB>, ARG> = MapArgumentToTypeSafe<TABLE_OR_VIEW, RequiredArgumentWhenValueMode<ARG>>;
export declare type UnsafeArgForBuilderIfValue<TABLE_OR_VIEW extends ITableOrViewRef<AnyDB>, ARG> = MapArgumentToTypeUnsafe<TABLE_OR_VIEW, RequiredArgumentWhenValueMode<ARG>>;
export declare type RemapValueSourceTypeIfValue<TABLE_OR_VIEW extends ITableOrViewRef<AnyDB>, TYPE> = TYPE extends IIfValueSource<any, infer T> ? (IfValueSource<TABLE_OR_VIEW, T>) : RemapValueSourceType<TABLE_OR_VIEW, TYPE>;
