import { ToSql, SqlBuilder, DeleteData, InsertData, UpdateData, SelectData, SqlOperation, WithQueryData, CompoundOperator, JoinData, QueryColumns, WithSelectData, WithValuesData } from "./SqlBuilder";
import { ITableOrView } from "../utils/ITableOrView";
import { AnyValueSource, IAggregatedArrayValueSource, IAnyBooleanValueSource, IExecutableDeleteQuery, IExecutableInsertQuery, IExecutableSelectQuery, IExecutableUpdateQuery, __AggregatedArrayColumns } from "../expressions/values";
...
export declare class AbstractSqlBuilder implements SqlBuilder {
    ...
    _appendSpreadValue(value: any, params: any[], columnType: string, typeAdapter: TypeAdapter | undefined, forceTypeCast?: boolean): string;
    _appendValue(value: any, params: any[], columnType: string, typeAdapter: TypeAdapter | undefined, forceTypeCast?: boolean): string;
    _appendValueParenthesis(value: any, params: any[], columnType: string, typeAdapter: TypeAdapter | undefined, forceTypeCast?: boolean): string;
    _appendValueParenthesisExcluding(value: any, params: any[], columnType: string, typeAdapter: TypeAdapter | undefined, excluding: keyof SqlOperation, forceTypeCast?: boolean): string;
    ...
    _appendConditionValue(value: any, params: any[], columnType: string, typeAdapter: TypeAdapter | undefined, forceTypeCast?: boolean): string;
    _appendConditionValueParenthesis(value: any, params: any[], columnType: string, typeAdapter: TypeAdapter | undefined, forceTypeCast?: boolean): string;
    _appendConditionValueParenthesisExcluding(value: any, params: any[], columnType: string, typeAdapter: TypeAdapter | undefined, excluding: keyof SqlOperation, forceTypeCast?: boolean): string;
