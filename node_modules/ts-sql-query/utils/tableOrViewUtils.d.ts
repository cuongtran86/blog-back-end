...
export declare type ColumnsOfShape<SHAPE> = ({
    [K in keyof SHAPE]-?: SHAPE[K] extends AnyValueSource & Column ? K : never;
})[keyof SHAPE];
...
export declare type ColumnsForSetOfShape<SHAPE> = ({
    [K in keyof SHAPE]-?: SHAPE[K] extends AnyValueSource & Column ? (SHAPE[K] extends ComputedColumn ? never : K) : never;
})[keyof SHAPE];
export declare type RequiredColumnsForSetOfShape<SHAPE> = ({
    [K in keyof SHAPE]-?: SHAPE[K] extends AnyValueSource & Column ? (SHAPE[K] extends ComputedColumn ? never : (SHAPE[K] extends OptionalColumn ? never : (SHAPE[K] extends ColumnWithDefaultValue ? never : K))) : never;
})[keyof SHAPE];
export declare type OptionalColumnsForSetOfShape<SHAPE> = ({
    [K in keyof SHAPE]-?: SHAPE[K] extends AnyValueSource & Column ? (SHAPE[K] extends ComputedColumn ? never : (SHAPE[K] extends OptionalColumn ? K : (SHAPE[K] extends ColumnWithDefaultValue ? K : never))) : never;
})[keyof SHAPE];
export declare type ColumnsForSetOfWithShape<TYPE extends ITableOrView<any>, SHAPE> = SHAPE extends undefined ? ColumnsForSetOf<TYPE> : ColumnsForSetOfShape<SHAPE>;
export {};
