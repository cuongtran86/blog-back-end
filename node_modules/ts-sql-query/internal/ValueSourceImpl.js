...
class ValueSourceImpl {
    constructor(valueType, optionalType, typeAdapter, aggregatedArrayColumns, aggregatedArrayMode, uuidString) {
        this[_a] = true;
...
class SqlOperationStatic0ValueSource extends ValueSourceImpl {
    constructor(operation, valueType, optionalType, typeAdapter) {
...
class BooleanValueWhenNoValueValueSource extends ValueSourceImpl {
    constructor(operation, valueSource, valueType, optionalType, typeAdapter) {
        super(valueType, optionalType, typeAdapter);
...
class ValueWhenNoValueValueSource extends ValueSourceImpl {
    constructor(valueWhenNoValue, valueSource, valueType, optionalType, typeAdapter) {
        super(valueType, optionalType, typeAdapter);
        this.__valueSource = valueSource;
...
class SqlOperationStatic1ValueSource extends ValueSourceImpl {
    constructor(operation, value, valueType, optionalType, typeAdapter) {
        super(valueType, optionalType, typeAdapter);
        this.__operation = operation;
        this.__value = value;
    }
...
class SqlOperationConstValueSource extends ValueSourceImpl {
    constructor(value, valueType, optionalType, typeAdapter) {
        super(valueType, optionalType, typeAdapter);
...
class SqlOperation1ValueSource extends ValueSourceImpl {
    constructor(operation, valueSource, value, valueType, optionalType, typeAdapter) {
        super(valueType, optionalType, typeAdapter);
        this.__valueSource = valueSource;
        this.__operation = operation;
        this.__value = value;
...
class SqlOperationValueWhenNullValueSource extends ValueSourceImpl {
    constructor(valueSource, value, valueType, optionalType, typeAdapter) {
        super(valueType, optionalType, typeAdapter);
        this.__valueSource = valueSource;
...
class SqlOperation2ValueSource extends ValueSourceImpl {
    constructor(operation, valueSource, value, value2, valueType, optionalType, typeAdapter) {
        super(valueType, optionalType, typeAdapter);
        this.__valueSource = valueSource;
        this.__operation = operation;
        this.__value = value;
...
class NoopValueSource extends ValueSourceImpl {
    constructor(valueSource, valueType, optionalType, typeAdapter) {
        super(valueType, optionalType, typeAdapter);
        this.__valueSource = valueSource;
    }
    __toSql(sqlBuilder, params) {
...
class SequenceValueSource extends ValueSourceImpl {
    constructor(operation, sequenceName, valueType, optionalType, typeAdapter) {
        super(valueType, optionalType, typeAdapter);
        this.__operation = operation;
...
class FragmentValueSource extends ValueSourceImpl {
    constructor(sql, sqlParams, valueType, optionalType, typeAdapter) {
        super(valueType, optionalType, typeAdapter);
...
class ValueSourceFromBuilder extends ValueSourceImpl {
    constructor(builder, fragmentBuilder, valueType, optionalType, typeAdapter) {
        super(valueType, optionalType, typeAdapter);
...
class NullValueSource extends ValueSourceImpl {
    constructor(valueType, optionalType, typeAdapter) {
        super(valueType, optionalType, typeAdapter);
...
class AggregateFunctions1or2ValueSource extends ValueSourceImpl {
    constructor(operation, separator, value, valueType, optionalType, typeAdapter) {
        super(valueType, optionalType, typeAdapter);
        this.__operation = operation;
...
function valueSourceInitializationForInlineSelect(selectData) {
    if (selectData.__asInlineAggregatedArrayValue) {
        ...
        return [valueSourcePrivate.__valueType, valueSourcePrivate.__optionalType, typeAdapter, valueSourcePrivate.__aggregatedArrayColumns, valueSourcePrivate.__aggregatedArrayMode, valueSourcePrivate.__uuidString];
    }
    else {
...
class AggregateValueAsArrayValueSource {
    constructor(aggregatedArrayColumns, aggregatedArrayMode, _optionalType) {
        this[_e] = true;
        this.__valueType = 'aggregatedArray';
...
class AllowWhenAggregateValueAsArrayValueSource extends AggregateValueAsArrayValueSource {
    constructor(allowed, error, aggregatedArrayColumns, aggregatedArrayMode, _optionalType) {
